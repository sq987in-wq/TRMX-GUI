...
android {
    namespace = "dev.trmx.gui"
    compileSdk = 34

    defaultConfig {
        applicationId = "dev.trmx.gui"
        minSdk = 26          // Phase 0 decision: Android 8.0 floor, user on 14+
        targetSdk = 34
        versionCode = 1
        versionName = "0.1.0"
    }
    ...
    testOptions {
        // unit tests must not die on incidental android.jar stubs (e.g. android.util.Log)
