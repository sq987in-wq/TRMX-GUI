...
| **UX-audit P0+P1 — Cognitive UX overhaul** | ✅ **Built & CI green (run 34502295508, ADR-012) — P0: wire typing (native JSON numbers), wrapping-button fix (custom wrap Layout), dotfiles default-hidden; P1: Command Center Home + Diagnostics sheet, human task labels, Custom command in Toolbox; on-device round pending** |
