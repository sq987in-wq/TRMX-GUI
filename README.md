...
| **Phase 7 — File manager** | ✅ **Complete — bridge §6 (list/ops/download/upload) + app browser; 49/49 Termux tests, CI green; on-device round pending** |
| Phases 8–12 | 🚫 not started (Phase 8 = polish & UX) |
