...
| **UX-audit P0–P2 — Cognitive UX overhaul** | ✅ **P0+P1 built & CI green (run 34502295508, ADR-012); P2 built — intent-card Home + hero workspace, dark platform theme (white-IME root fix), native TopAppBars, human Files rows + details sheet, Ready/Setup-required cards, Chains empty state — CI pending** |
